...
- **Distributed AI**
  ...
  - **Distributed AI system optimization**: Resource Allocation, Data Privacy, Model Aggregation and Inference, etc.
- **Blockchain**
  - **Blockchain system optimization**: Scalability, Security Decentralization, etc.
  - **Blockchain incentive protocols**: Real World Asset (RWA) Tokenization, Decentralized Finance (DeFi), etc.
  - **Blockchain Security**: Smart Contract Security, Abnormal Transaction Monitoring and Detection, etc.
